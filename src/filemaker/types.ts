// ============================================================
// FileMaker Data API Type Definitions
// ============================================================
...
export interface FMRecord {
  ...
  portalDataInfo?: Record<string, { foundCount: number }>;
}
...
/** 通用 API 响应 */
export type FMApiResponse =
  | FMTokenResponse
  | FMLayoutMetadataResponse
  | FMLayoutListResponse
  | FMRecordListResponse
  | FMRecordResponse
  | FMCreateRecordResponse
  | FMDeleteResponse
  | FMFindResponse
  | FMScriptListResponse
  | FMRunScriptResponse;
