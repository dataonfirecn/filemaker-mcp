...
export const basicSections: Record<string, string[]> = {
  ...
  '报价信息': ['RMB成本', '美金成本', 'EX-Price', '台幣出廠', 'RMB出廠', 'MOQ', 'Retail_Price_USD', '建議報價', 'opencost', '組裝成本USD', '組裝成本', '其他成本估價', '匯率', '成本加成', '報價積數', '應課稅', '提成', '提成B', '報價紀錄', '關聯編號_Price', '時薪', '準備工時分', '準備工時秒', '準備工時數量', '包裝工時分', '包裝工時秒', '準備工時單包', '包裝工時單包', '準備包裝工錢', '包裝工錢', '包裝總工錢', '總人工成本'],
