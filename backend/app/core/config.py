...
class Settings(BaseSettings):
    ...
    # FileMaker Data API find requests use the file/database locale. The
    # deployed StarRC layouts validate dates in month/day/year order.
    ...
    nightly_query_analytics_schedule_time: str = "00:30"
    ...
    customer_portal_public_url: str = "https://stockcheck.net/customer-chat"
    ...
    customer_smtp_from_name: str = "Stock Check"
