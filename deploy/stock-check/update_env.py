"""Update non-secret Stock Check deployment settings without printing secrets."""
...
def main() -> None:
    ...
    account_found = False
    for line in lines:
        if line.startswith(("STOCK_CHECK_BACKEND_IMAGE=", "MAYAKO_BACKEND_IMAGE=")):
            line = f"STOCK_CHECK_BACKEND_IMAGE={args.backend_image}"
        elif line.startswith(("STOCK_CHECK_FRONTEND_IMAGE=", "MAYAKO_FRONTEND_IMAGE=")):
            line = f"STOCK_CHECK_FRONTEND_IMAGE={args.frontend_image}"
